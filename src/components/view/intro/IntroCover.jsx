      ...
      <Col xs={12} sm={6} md={6} lg={6}>
        <div className="intro-text body-1 yellow-background">
          <p>
            ...
            content related to that topic. Why does this happen? It’s because of
            sites tracking your online movements and, of course, the algorithms.
            <br />
            <br />
            ...
            <br />
            <br />
            This project aims to provide insight into how content farms work and
            algorithms of online platforms such as YouTube and how understanding
            this can allow a better browsing experience.
          </p>
